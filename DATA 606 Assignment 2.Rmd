...
patient got a transplant? Explain your reasoning.
        ...
        No, it appears survival is dependent on whether the patient recieved a transplant. The control groups area appears to be significantly taller than the treatment group, the opposite is true for the survival areas. It is noted that many more people appear to be in treatment group than the control group, which may cause some issues with determining whether the treatment has a significant affect on survival rate.
        
(b) What do the box plots below suggest about the efficacy (effectiveness) of the heart transplant treatment.
        
        The heart transplant treatment significantly increases the survival time (days) for patients. it appears all measurements of the data (e.g. Q1, median, etc.) are significantly better for the treatment group than the control group.
