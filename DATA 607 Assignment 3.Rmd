...
```{r, install stringr package, include=TRUE}
...
```{r, extract ammount and currency, echo=TRUE}
...
t <- c(".txt","alpha.txt","test.txt", "huge.txt", "99999.txt")
...
t <- c("<h1>Report Heading</h1>","<h1></h1>","<p>S. Kigamba<br>89 Born<br>Sydney</p>","<img src='school.gif' alt='School library' height='20' width='60'>")
