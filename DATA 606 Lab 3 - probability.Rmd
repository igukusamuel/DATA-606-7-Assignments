...
2.  Describe the distribution of Kobe's streak lengths from the 2009 NBA finals. 
   ...
   What was his typical streak length? How long was his longest streak of baskets?
        ...
        The typical streak length was a zero (0). The longest streak length was 4.
...
-   Describe the distribution of streak lengths. What is the typical streak 
    ...
    The independent shooter has a typical shoting streak of zero (0). The streak distribution is unimodal having only one prominent peak and is         skewed to the right with a long right tail.
...
-   How does Kobe Bryant's distribution of streak lengths compare to the 
   ...
   shooting patterns? Explain.
    ...
    There is no evidence to support that the hot hand model fits kobe's shooting patterns since both models are somewhat similar.
